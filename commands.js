...
banner = [
  'NeoGenetics (BR) Not A Corporation. All rights reserved.',
  " (=(   )=)                                                  (=(   )=)",
  "  `.\ /,'                                                    `.\ /,' ",
  "    `\.                                                        `\.   ",
  "  ,'/ \`.                                                    ,'/ \`. ",
  " (=(   )=)    _  _          ___              _   _          (=(   )=)",
  "  `.\ /,'    | \| |___ ___ / __|___ _ _  ___| |_(_)__ ___    `.\ /,' ",
  "    ,/'      | .` / -_) _ \ (_ / -_) ' \/ -_)  _| / _(_-<      ,/'   ",
  "  ,'/ \`.    |_|\_\___\___/\___\___|_||_\___|\__|_\__/__/    ,'/ \`. ",
  " (=(   )=)                                                  (=(   )=)",
  "  `.\ /,'                                                    `.\ /,' ",
  "    ,/'                                                        ,/'   ",
  "  ,'/ \`.                                                    ,'/ \`. ",
  " (=(   )=)                                                  (=(   )=)",
  'Welcome to NeoGenetics terminal.',
